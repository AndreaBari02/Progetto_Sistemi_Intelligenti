(define (problem problem_6x6_v2) (:domain domain_6x6_v2)
    ...
    (:init
        ...
        (robot_at_cell robot2 c31)
        (robot_at_cell robot3 c20)
        (box_at_cell box1 c36)
        (box_at_cell box2 c30)
        (box_at_cell box3 c23)
 
        (occupied_by_robot c1)
        (occupied_by_robot c31)
        (occupied_by_robot c20)
    ...
    (:goal
        (and
            (robot_at_cell robot1 c31)
            (robot_at_cell robot2 c20)
            (robot_at_cell robot3 c1)
            (box_at_cell box1 c5)
            (arrived_at_dest box1 c5)
            (box_at_cell box2 c10)
            (arrived_at_dest box2 c10)
            (box_at_cell box3 c25)
            (arrived_at_dest box3 c25)
        )
    )
)