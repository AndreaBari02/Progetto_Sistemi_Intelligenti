(define (problem problem_7x7_v2) (:domain domain_7x7_v2)
    ...
    (:init
        ...
        (robot_at_cell robot2 c4)
        (robot_at_cell robot3 c7)
 
        (box_at_cell box1 c45)
        (box_at_cell box2 c46)
        (box_at_cell box3 c47)
 
        (occupied_by_robot c1)
        (occupied_by_robot c4)
        (occupied_by_robot c7)
 
        (occupied_by_obstacle c2)
        (occupied_by_obstacle c3)
        (occupied_by_obstacle c5)
    ...
    (:goal
        (and
            ...
            (robot_at_cell robot2 c4)
            (robot_at_cell robot3 c7)
            (box_at_cell box3 c49)
            (arrived_at_dest box3 c49)
            (box_at_cell box1 c43)
            (arrived_at_dest box1 c43)
            (box_at_cell box2 c11)
            (arrived_at_dest box2 c11)
        )
    )
)